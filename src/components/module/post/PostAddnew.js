...
const PostAddnew = () => {
  ...
  const {image,progress,handleDeleteImage,handleResetUpload,handleSelectImage}= useFireBaseImage(getValues,setValue) 
  ...
  return (
    <PostAddNewStyles>
      ...
      <form onSubmit={handleSubmit(addPostHandler)}>
        ...
        <Dropdown>
        <Dropdown.Select placeholder={`${selectCategory.name || "please select category"}`}></Dropdown.Select>
        <Dropdown.List>
